<template>
  ...
  <div class="relative flex justify-between items-center">
    ...
    <div class="absolute top-6 left-0 h-1 bg-indigo-500 rounded-full transition-all duration-300"
         style="width: 5%">
    </div>
    ...
    >
      ...
      <div
        class="w-12 h-12 flex items-center justify-center rounded-full border-2 
               border-indigo-500 bg-white shadow-md transition-all duration-300"
      >
        <i :class="step.icon" class="text-indigo-500 text-lg"></i>
      </div>

      <!-- Title -->
      <h1 class="mt-3 text-sm font-medium text-gray-600 text-center">
        {{ step.title }}
      </h1>
    </div>
